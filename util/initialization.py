...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 3:
        ...
        raise Exception("please provide your open ai api_key as the first argument to the program. Second argument is"
    ...
    test_docs, number_of_tokens = summarization_obj.split_input_text_to_tokens(input_text)
